...
//
  ...
  std::string nick_name="zs";
  std::string school="xust";
  std::string message="nihao";
  std::string type="1";
  ValueObj root;
  ...
  Write mywrite;
   mywrite.run(root,out_string);//序列化成一个字符串
    //反序列化
    cout<<out_string<<endl;
     Read r;
     r.run(out_string,root);
   string nick_name1 = root["nick_name"];
   string school1 = root["school"];
  string message1 = root["message"];
  string  type1 =root["type"]; 
 	  //cout << "ok"<<endl;
    //cout<<nick_name1<<endl;
    //cout<<school1<<endl;
    //cout<<message1<<endl;
    //cout<<type1<<endl;
//
